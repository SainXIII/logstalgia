...
void Logstalgia::init() {
    ...
    if(summarizers.empty()) {
        ...
        addGroup("URI", "Team[1]", "(?i)10.10.1\\.2.*", 11);
        addGroup("URI", "Team[2]", "(?i)10.10.2\\.2.*", 11);
        addGroup("URI", "Team[3]", "(?i)10.10.3\\.2.*", 11);
        addGroup("URI", "Team[4]", "(?i)10.10.4\\.2.*", 11);
        addGroup("URI", "Team[5]", "(?i)10.10.5\\.2.*", 11);
        addGroup("URI", "支持中文", "(?i)10.10.6\\.2.*", 11);
        addGroup("URI", "还是支持中文", "(?i)10.10.7\\.2.*", 11);
        addGroup("URI", "Team[8]", "(?i)10.10.8\\.2.*", 11);
        addGroup("URI", "NPC", "(?i)10.10.0\\.2.*", 11);

        //addGroup("URI", "Team[1]", "(?i)GameBox\\[1\\].*", 11);
        //addGroup("URI", "Team[2]", "(?i)GameBox\\[2\\].*", 11);
        //addGroup("URI", "Team[3]", "(?i)GameBox\\[3\\].*", 11);
        //addGroup("URI", "Team[4]", "(?i)GameBox\\[4\\].*", 11);
        //addGroup("URI", "Team[5]", "(?i)GameBox\\[5\\].*", 11);
        //addGroup("URI", "Team[6]", "(?i)GameBox\\[6\\].*", 11);
        //addGroup("URI", "Team[7]", "(?i)GameBox\\[7\\].*", 11);
        //addGroup("URI", "Team[8]", "(?i)GameBox\\[8\\].*", 11);
        //addGroup("URI", "NPC", "(?i)GameBox\\[9\\].*", 11);

        //addGroup("URI", "MasterServer", "(?i)10.10.10\\..*", 10);
